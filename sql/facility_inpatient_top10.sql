...
SELECT c.claim_id, c.member_id, c.drg, c.prin_dx, c.tob, c.fac_npi,
       ...
       + (0.10 * COALESCE(ro.inter / NULLIF(cc.n, 0), 0))     -- PCS/proc overlap proxy
